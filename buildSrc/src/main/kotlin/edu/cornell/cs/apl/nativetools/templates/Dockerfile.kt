...
internal val linuxDockerfile = Platform.LINUX_64.let { platform ->
    ...
    # Build for Linux
    FROM dockcross/manylinux2014-x64:20211004-ae670cd as ${platform.safeName}
    CMD ["/bin/bash"]
...
internal val macosDockerfile = Platform.MACOS_64.let { platform ->
    ...
    ## Install Conan
    RUN wget --quiet https://github.com/conan-io/conan/releases/download/1.41.0/conan-ubuntu-64.deb -O conan.deb \
        && dpkg -i conan.deb \
        && rm conan.deb
